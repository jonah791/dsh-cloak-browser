# dsh-cloak-browser · 语义文档

> 元信息：版本 v0.1 · 状态 draft · 最近复核 2026-09-16 · owner agent-cloak-browser

## 1 · 定位与反定位

**是什么**：CloakBrowser（补丁版 Chromium）生命周期工具：把 20 个加固参数固化为 start/stop/status 三个工具
